...
<body>
    ...
    <main style="margin-top: 58px">
        <div class="container pt-4">
            ...
            <table class="display nowrap" id="recipients-account-table">
    ...
    <script>
        ...
        const date = document.getElementsByClassName("gendate");
        var today = new Date().toISOString().split('T')[0];
        // document.getElementsByName("gendate")[0].setAttribute('min', today);
